...
//        objectHandler.addObject(wallObjectBottom);
        ...
        TankObject playerOneTank = new TankObject(100, 500, TankType.PLAYER_ONE_TANK_TYPE, objectHandler);
        TankObject playerTwoTank = new TankObject(800, 500, TankType.PLAYER_TWO_TANK_TYPE, objectHandler);
        objectHandler.addObject(playerOneTank);
        objectHandler.addHittableObject(playerOneTank);
        objectHandler.addObject(playerTwoTank);
        objectHandler.addHittableObject(playerTwoTank);
